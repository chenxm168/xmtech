...
namespace WinSECS
{
    public class S1F6_EQPJOBREPLY_TYPE2_TOOL_COUNT_JOB_COUNT_GLASS_COUNT
    {
        ...
        public S1F6_EQPJOBREPLY_TYPE2_TOOL_COUNT_JOB_COUNT_GLASS_COUNT(String slotno, String processid, String partid, String stepid, String glasstype, String lotid, String glassid, String ppid, String cellgrade, String lotaction)
        {
			this.slotno = slotno;

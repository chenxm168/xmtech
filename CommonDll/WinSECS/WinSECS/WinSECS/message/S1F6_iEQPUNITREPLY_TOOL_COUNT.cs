...
namespace WinSECS
{
    public class S1F6_iEQPUNITREPLY_TOOL_COUNT
    {
        private ListFormat ownerList = new ListFormat();

		private String toolid= "";
		private List<S1F6_iEQPUNITREPLY_TOOL_COUNT_UNIT_COUNT> unit_count= new List<S1F6_iEQPUNITREPLY_TOOL_COUNT_UNIT_COUNT>();

        public S1F6_iEQPUNITREPLY_TOOL_COUNT(String toolid, List<S1F6_iEQPUNITREPLY_TOOL_COUNT_UNIT_COUNT> unit_count)
        {
			this.toolid = toolid;
        ...
        public ListFormat getMessage(bool isNoPadding)
        {
			...
			if(unit_count != null)
			{
				foreach (S1F6_iEQPUNITREPLY_TOOL_COUNT_UNIT_COUNT item in unit_count)
				{

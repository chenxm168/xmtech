...
namespace WinSECS
{
    public class S3F102_CASSETTEINFORMATIONREPLY_TYPE4
    {
        public static SECSTransaction makeTransaction(bool isNoPadding , String ack6, String ptid, String csid, String jobid, String device, String stif, List<S3F102_CASSETTEINFORMATIONREPLY_TYPE4_GLASS_COUNT> glass_count)
        {
			...
			sArray =  stif.Split(' ');
			if (isNoPadding)
				listNode_1.add(AsciiFormat.TYPE, sArray.Length, "STIF", stif);
			else
			...
			if(glass_count != null)
			{
				foreach (S3F102_CASSETTEINFORMATIONREPLY_TYPE4_GLASS_COUNT item in glass_count)
				{

...
namespace WinSECS
{
    public class S1F6_iEQPLOCALSTATUSREPLY_TOOL_COUNT
    {
        ...
        public S1F6_iEQPLOCALSTATUSREPLY_TOOL_COUNT(String toolid, String mcmd, String eqst, String eqstate, String ppid, String glasssize, String direction, String lotkind, String tact, String stdcell, String glasstype, String cutrule)
        {
			this.toolid = toolid;
			this.mcmd = mcmd;
			this.eqst = eqst;

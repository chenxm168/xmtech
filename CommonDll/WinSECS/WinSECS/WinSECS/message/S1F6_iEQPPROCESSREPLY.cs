...
namespace WinSECS
{
    public class S1F6_iEQPPROCESSREPLY
    {
        public static SECSTransaction makeTransaction(bool isNoPadding , String sfcd, List<S1F6_iEQPPROCESSREPLY_TOOL_COUNT> tool_count)
        {
			...
			if(tool_count != null)
			{
				foreach (S1F6_iEQPPROCESSREPLY_TOOL_COUNT item in tool_count)
				{

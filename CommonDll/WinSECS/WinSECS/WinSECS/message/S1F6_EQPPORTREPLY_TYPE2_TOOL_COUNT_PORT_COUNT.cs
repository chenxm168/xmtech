...
namespace WinSECS
{
    public class S1F6_EQPPORTREPLY_TYPE2_TOOL_COUNT_PORT_COUNT
    {
        ...
        public S1F6_EQPPORTREPLY_TYPE2_TOOL_COUNT_PORT_COUNT(String ptid, String csid, String tspt, String stif, String porttype, String csttype)
        {
			this.ptid = ptid;
			this.csid = csid;
			this.tspt = tspt;

...
namespace WinSECS
{
    class S7F23_RMSFORMATTEDPPIDCHANGEREQUEST_A
    {
		...
		private String mode= "";
		private List<S7F23_RMSFORMATTEDPPIDCHANGEREQUEST_A_TOOL_COUNT> tool_count= new List<S7F23_RMSFORMATTEDPPIDCHANGEREQUEST_A_TOOL_COUNT>();
		...
		public List<S7F23_RMSFORMATTEDPPIDCHANGEREQUEST_A_TOOL_COUNT> TOOL_COUNT
		{
        ...
        public S7F23_RMSFORMATTEDPPIDCHANGEREQUEST_A(SECSTransaction trx)
        {
            this.trx = trx;
        ...
        public void FillItemValue(SECSTransaction trx)
        {
			...
			{
				S7F23_RMSFORMATTEDPPIDCHANGEREQUEST_A_TOOL_COUNT vList = new S7F23_RMSFORMATTEDPPIDCHANGEREQUEST_A_TOOL_COUNT();

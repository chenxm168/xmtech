...
namespace WinSECS
{
    public class S1F12_FDCEQPSTATUSNAMELISTREPLY_TYPE1_TOOL_COUNT_SVID_COUNT
    {
        ...
        public S1F12_FDCEQPSTATUSNAMELISTREPLY_TYPE1_TOOL_COUNT_SVID_COUNT(String svid, String svname, String unitid)
        {
			this.svid = svid;
			this.svname = svname;
			this.unitid = unitid;

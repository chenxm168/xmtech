...
namespace WinSECS
{
    public class S6F13_DFSDATACOLLECTION_TYPE2
    {
        public static SECSTransaction makeTransaction(bool isNoPadding , String dataid, String ceid, String rptid, String ipidname, String ipid, String opidname, String opid, String icidname, String icid, String ocidname, String ocid, String jobidname, String jobid, String host_slotnoname, String host_slotno, String processidname, String processid, String partidname, String partid, String stepidname, String stepid, String glasstypename, String glasstype, String lotidname, String lotid, String host_glassidname, String host_glassid, String ppidname, String ppid, String glassstatename, String gstate, String out_slotnoname, String out_slotno, String vcr_glassidname, String vcr_glassid, String glass_sizename, String glass_size, String rptid1, String rawpathname, String rawpath, String sumpathname, String sumpath, String imgpathname, String imgpath, String diskname, String disk)
        {
			...
			ListFormat listNode_22 = listNode_LEVEL_COUNT.add(ListFormat.TYPE, 2, "", "") as ListFormat;
			ListFormat listNode_FIRST_COUNT = listNode_22.add(ListFormat.TYPE, 4, "FIRST_COUNT", "") as ListFormat;
			ListFormat listNode_23 = listNode_FIRST_COUNT.add(ListFormat.TYPE, 2, "", "") as ListFormat;
			if (isNoPadding)
				listNode_23.add(AsciiFormat.TYPE, Encoding.GetEncoding("ks_c_5601-1987").GetBytes(rawpathname).Length, "RAWPATHNAME", rawpathname);
			else
				listNode_23.add(AsciiFormat.TYPE, 16, "RAWPATHNAME", rawpathname);
			if (isNoPadding)
				listNode_23.add(AsciiFormat.TYPE, Encoding.GetEncoding("ks_c_5601-1987").GetBytes(rawpath).Length, "RAWPATH", rawpath);
			else
				listNode_23.add(AsciiFormat.TYPE, 80, "RAWPATH", rawpath);
			ListFormat listNode_24 = listNode_FIRST_COUNT.add(ListFormat.TYPE, 2, "", "") as ListFormat;
			if (isNoPadding)
				listNode_24.add(AsciiFormat.TYPE, Encoding.GetEncoding("ks_c_5601-1987").GetBytes(sumpathname).Length, "SUMPATHNAME", sumpathname);
			else
				listNode_24.add(AsciiFormat.TYPE, 16, "SUMPATHNAME", sumpathname);
			if (isNoPadding)
				listNode_24.add(AsciiFormat.TYPE, Encoding.GetEncoding("ks_c_5601-1987").GetBytes(sumpath).Length, "SUMPATH", sumpath);
			else
				listNode_24.add(AsciiFormat.TYPE, 80, "SUMPATH", sumpath);
			ListFormat listNode_25 = listNode_FIRST_COUNT.add(ListFormat.TYPE, 2, "", "") as ListFormat;
			if (isNoPadding)
				listNode_25.add(AsciiFormat.TYPE, Encoding.GetEncoding("ks_c_5601-1987").GetBytes(imgpathname).Length, "IMGPATHNAME", imgpathname);
			else
				listNode_25.add(AsciiFormat.TYPE, 16, "IMGPATHNAME", imgpathname);
			if (isNoPadding)
				listNode_25.add(AsciiFormat.TYPE, Encoding.GetEncoding("ks_c_5601-1987").GetBytes(imgpath).Length, "IMGPATH", imgpath);
			else
				listNode_25.add(AsciiFormat.TYPE, 80, "IMGPATH", imgpath);
			ListFormat listNode_26 = listNode_FIRST_COUNT.add(ListFormat.TYPE, 2, "", "") as ListFormat;
			if (isNoPadding)
				listNode_26.add(AsciiFormat.TYPE, Encoding.GetEncoding("ks_c_5601-1987").GetBytes(diskname).Length, "DISKNAME", diskname);
			else
				listNode_26.add(AsciiFormat.TYPE, 16, "DISKNAME", diskname);
			if (isNoPadding)
				listNode_26.add(AsciiFormat.TYPE, Encoding.GetEncoding("ks_c_5601-1987").GetBytes(disk).Length, "DISK", disk);
			else
				listNode_26.add(AsciiFormat.TYPE, 80, "DISK", disk);
			ListFormat listNode_27 = listNode_22.add(ListFormat.TYPE, 0, "", "") as ListFormat;

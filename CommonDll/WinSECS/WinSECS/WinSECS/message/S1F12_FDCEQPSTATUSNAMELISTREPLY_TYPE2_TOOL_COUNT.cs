...
namespace WinSECS
{
    public class S1F12_FDCEQPSTATUSNAMELISTREPLY_TYPE2_TOOL_COUNT
    {
        private ListFormat ownerList = new ListFormat();

		private String toolid= "";
		private String tiack= "";
		private List<S1F12_FDCEQPSTATUSNAMELISTREPLY_TYPE2_TOOL_COUNT_SVID_COUNT> svid_count= new List<S1F12_FDCEQPSTATUSNAMELISTREPLY_TYPE2_TOOL_COUNT_SVID_COUNT>();

        public S1F12_FDCEQPSTATUSNAMELISTREPLY_TYPE2_TOOL_COUNT(String toolid, String tiack, List<S1F12_FDCEQPSTATUSNAMELISTREPLY_TYPE2_TOOL_COUNT_SVID_COUNT> svid_count)
        {
			this.toolid = toolid;
			this.tiack = tiack;
        ...
        public ListFormat getMessage(bool isNoPadding)
        {
			...
			if(svid_count != null)
			{
				foreach (S1F12_FDCEQPSTATUSNAMELISTREPLY_TYPE2_TOOL_COUNT_SVID_COUNT item in svid_count)
				{

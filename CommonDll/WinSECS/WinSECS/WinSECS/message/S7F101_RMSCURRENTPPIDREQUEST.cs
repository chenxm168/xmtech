...
namespace WinSECS
{
    class S7F101_RMSCURRENTPPIDREQUEST
    {
        private BasicTransactionInfo basicTrxInfo;
        private SECSTransaction trx;

		private List<S7F101_RMSCURRENTPPIDREQUEST_TOOL_COUNT> tool_count= new List<S7F101_RMSCURRENTPPIDREQUEST_TOOL_COUNT>();
		...
		public List<S7F101_RMSCURRENTPPIDREQUEST_TOOL_COUNT> TOOL_COUNT
		{
        ...
        public S7F101_RMSCURRENTPPIDREQUEST(SECSTransaction trx)
        {
            this.trx = trx;
        ...
        public void FillItemValue(SECSTransaction trx)
        {
			...
			{
				S7F101_RMSCURRENTPPIDREQUEST_TOOL_COUNT vList = new S7F101_RMSCURRENTPPIDREQUEST_TOOL_COUNT();

...
namespace WinSECS
{
    class S1F3_NOUSE_1
    {
		...
		private List<S1F3_NOUSE_1_TOOL_COUNT> tool_count= new List<S1F3_NOUSE_1_TOOL_COUNT>();
		...
		public List<S1F3_NOUSE_1_TOOL_COUNT> TOOL_COUNT
		{
        ...
        public S1F3_NOUSE_1(SECSTransaction trx)
        {
            this.trx = trx;
        ...
        public void FillItemValue(SECSTransaction trx)
        {
			...
			{
				S1F3_NOUSE_1_TOOL_COUNT vList = new S1F3_NOUSE_1_TOOL_COUNT();

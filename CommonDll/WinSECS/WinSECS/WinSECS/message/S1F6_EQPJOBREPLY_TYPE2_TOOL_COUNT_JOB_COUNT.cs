...
namespace WinSECS
{
    public class S1F6_EQPJOBREPLY_TYPE2_TOOL_COUNT_JOB_COUNT
    {
		...
		private List<S1F6_EQPJOBREPLY_TYPE2_TOOL_COUNT_JOB_COUNT_GLASS_COUNT> glass_count= new List<S1F6_EQPJOBREPLY_TYPE2_TOOL_COUNT_JOB_COUNT_GLASS_COUNT>();

        public S1F6_EQPJOBREPLY_TYPE2_TOOL_COUNT_JOB_COUNT(String ipid, String opid, String icid, String ocid, String jobid, String jstate, String stif, String totalgstate, List<S1F6_EQPJOBREPLY_TYPE2_TOOL_COUNT_JOB_COUNT_GLASS_COUNT> glass_count)
        {
			this.ipid = ipid;
			this.opid = opid;
			this.icid = icid;
        ...
        public ListFormat getMessage(bool isNoPadding)
        {
			...
			if(glass_count != null)
			{
				foreach (S1F6_EQPJOBREPLY_TYPE2_TOOL_COUNT_JOB_COUNT_GLASS_COUNT item in glass_count)
				{

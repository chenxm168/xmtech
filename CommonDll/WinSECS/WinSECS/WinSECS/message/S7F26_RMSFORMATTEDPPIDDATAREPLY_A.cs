...
namespace WinSECS
{
    public class S7F26_RMSFORMATTEDPPIDDATAREPLY_A
    {
        public static SECSTransaction makeTransaction(bool isNoPadding , String ppid, String mdln, String softrev, List<S7F26_RMSFORMATTEDPPIDDATAREPLY_A_TOOL_COUNT> tool_count)
        {
			...
			if(tool_count != null)
			{
				foreach (S7F26_RMSFORMATTEDPPIDDATAREPLY_A_TOOL_COUNT item in tool_count)
				{

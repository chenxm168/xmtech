...
namespace WinSECS
{
    public class S6F11_JOBPROCESSEVENT_TYPE1_GLASS_COUNT
    {
        ...
        public S6F11_JOBPROCESSEVENT_TYPE1_GLASS_COUNT(String slotno, String processid, String partid, String stepid, String glasstype, String lotid, String glassid, String ppid, String cellgrade, String lotaction)
        {
			this.slotno = slotno;

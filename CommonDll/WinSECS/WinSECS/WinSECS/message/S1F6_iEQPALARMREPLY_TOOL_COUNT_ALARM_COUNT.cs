...
namespace WinSECS
{
    public class S1F6_iEQPALARMREPLY_TOOL_COUNT_ALARM_COUNT
    {
        ...
        public S1F6_iEQPALARMREPLY_TOOL_COUNT_ALARM_COUNT(String alcd, String alid, String altx, String altm, String unitid)
        {
			this.alcd = alcd;
			this.alid = alid;
			this.altx = altx;

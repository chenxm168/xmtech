...
namespace WinSECS
{
    public class S6F11_iSPECIALEVENT
    {
        public static SECSTransaction makeTransaction(bool isNoPadding , String dataid, String ceid, String rptid, String toolid, String mcmd, String eqst, String bywho, String rptid1, List<S6F11_iSPECIALEVENT_MATERIAL_COUNT> material_count)
        {
			...
			{
				foreach (S6F11_iSPECIALEVENT_MATERIAL_COUNT item in material_count)
				{

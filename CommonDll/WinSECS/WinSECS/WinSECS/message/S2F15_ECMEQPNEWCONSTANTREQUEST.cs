...
namespace WinSECS
{
    class S2F15_ECMEQPNEWCONSTANTREQUEST
    {
        private BasicTransactionInfo basicTrxInfo;
        private SECSTransaction trx;

		private List<S2F15_ECMEQPNEWCONSTANTREQUEST_TOOL_COUNT> tool_count= new List<S2F15_ECMEQPNEWCONSTANTREQUEST_TOOL_COUNT>();
		...
		public List<S2F15_ECMEQPNEWCONSTANTREQUEST_TOOL_COUNT> TOOL_COUNT
		{
        ...
        public S2F15_ECMEQPNEWCONSTANTREQUEST(SECSTransaction trx)
        {
            this.trx = trx;
        ...
        public void FillItemValue(SECSTransaction trx)
        {
			...
			{
				S2F15_ECMEQPNEWCONSTANTREQUEST_TOOL_COUNT vList = new S2F15_ECMEQPNEWCONSTANTREQUEST_TOOL_COUNT();

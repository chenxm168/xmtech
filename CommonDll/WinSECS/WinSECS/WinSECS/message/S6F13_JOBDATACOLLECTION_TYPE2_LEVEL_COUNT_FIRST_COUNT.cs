...
namespace WinSECS
{
    public class S6F13_JOBDATACOLLECTION_TYPE2_LEVEL_COUNT_FIRST_COUNT
    {
        ...
        public S6F13_JOBDATACOLLECTION_TYPE2_LEVEL_COUNT_FIRST_COUNT(String name1, String value1)
        {
			this.name1 = name1;
			this.value1 = value1;

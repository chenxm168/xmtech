...
namespace WinSECS
{
    public class S6F11_iCOMPONENTEVENT_TYPE1
    {
        public static SECSTransaction makeTransaction(bool isNoPadding , String dataid, String ceid, String rptid, String toolid, String mcmd, String eqst, String bywho, String rptid1, String ipid, String icid, String jobid, String processid, String partid, String stepid, String glasstype, String lotid, String hglassid, String rglassid, String ppid, String cellgrade, String direction, String glasssize, String stdcell, String lotkind, String runline, String position, String pairslotno, String pairipid, String pairicid, String pairlotid, String pairhglassid, String pairrglassid, String glassfifo, String systembyte, String tact, String fslotid, String course, String cutrule, String eo_val, String unitid, String result, String judgement, String ngcode)
        {
			...
			ListFormat listNode_6 = listNode_5.add(ListFormat.TYPE, 30, "", "") as ListFormat;
			if (isNoPadding)
			...
			if (isNoPadding)
				...
				listNode_6.add(AsciiFormat.TYPE, 20, "CELLGRADE", cellgrade);
			if (isNoPadding)
			...
			if (isNoPadding)
				listNode_6.add(AsciiFormat.TYPE, Encoding.GetEncoding("ks_c_5601-1987").GetBytes(cutrule).Length, "CUTRULE", cutrule);
			else
				listNode_6.add(AsciiFormat.TYPE, 16, "CUTRULE", cutrule);

...
namespace WinSECS
{
    public class S6F11_F1PSH01_1_GLASS_COUNT
    {
        ...
        public S6F11_F1PSH01_1_GLASS_COUNT(String slotno, String processid, String partid, String stepid, String glasstype, String lotid, String glassid, String ppid, String cellgrade, String location, String glasssize, String pairrglassid)
        {
			this.slotno = slotno;
        ...
        public ListFormat getMessage(bool isNoPadding)
        {
			...
			if (isNoPadding)
				...
				ownerList.add(AsciiFormat.TYPE, 16, "LOCATION", location);
			if (isNoPadding)

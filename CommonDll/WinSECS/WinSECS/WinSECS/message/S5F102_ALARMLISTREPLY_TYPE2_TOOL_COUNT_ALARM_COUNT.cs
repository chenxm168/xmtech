...
namespace WinSECS
{
    public class S5F102_ALARMLISTREPLY_TYPE2_TOOL_COUNT_ALARM_COUNT
    {
        ...
        public S5F102_ALARMLISTREPLY_TYPE2_TOOL_COUNT_ALARM_COUNT(String alcd, String alid, String altx, String altm, String unitid)
        {
			this.alcd = alcd;
			this.alid = alid;
			this.altx = altx;

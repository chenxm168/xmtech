...
namespace WinSECS
{
    public class S6F11_iPROCESSEVENT_TYPE1
    {
        public static SECSTransaction makeTransaction(bool isNoPadding , String dataid, String ceid, String rptid, String toolid, String mcmd, String eqst, String bywho, String rptid1, String ptid, String csid, String ipid, String icid, String jobidp, String totalgstate, List<S6F11_iPROCESSEVENT_TYPE1_GLASS_COUNT> glass_count, String rptid2, String receivemode, String unloadtype, String splitmode, String ptst, String ptmd, String bcrmode, String vcrmode, String sortmode)
        {
			...
			if(glass_count != null)
			{
				foreach (S6F11_iPROCESSEVENT_TYPE1_GLASS_COUNT item in glass_count)
				{
			...
			ListFormat listNode_7 = listNode_6.add(ListFormat.TYPE, 8, "", "") as ListFormat;
			if (isNoPadding)
			...
			if (isNoPadding)
				listNode_7.add(AsciiFormat.TYPE, Encoding.GetEncoding("ks_c_5601-1987").GetBytes(ptmd).Length, "PTMD", ptmd);
			else

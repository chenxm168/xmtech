...
namespace WinSECS
{
    public class S6F13_JOBDATACOLLECTION_TYPE3_LEVEL_COUNT_SECOND_COUNT_THIRD_COUNT
    {
        ...
        public S6F13_JOBDATACOLLECTION_TYPE3_LEVEL_COUNT_SECOND_COUNT_THIRD_COUNT(String name2, String value2)
        {
			this.name2 = name2;
			this.value2 = value2;

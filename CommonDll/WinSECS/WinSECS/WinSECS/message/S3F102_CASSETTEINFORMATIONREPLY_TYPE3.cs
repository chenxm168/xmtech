...
namespace WinSECS
{
    public class S3F102_CASSETTEINFORMATIONREPLY_TYPE3
    {
        public static SECSTransaction makeTransaction(bool isNoPadding , String ack6, String ptid, String csid, String jobid, String device, List<S3F102_CASSETTEINFORMATIONREPLY_TYPE3_GLASS_COUNT> glass_count)
        {
			...
			if(glass_count != null)
			{
				foreach (S3F102_CASSETTEINFORMATIONREPLY_TYPE3_GLASS_COUNT item in glass_count)
				{

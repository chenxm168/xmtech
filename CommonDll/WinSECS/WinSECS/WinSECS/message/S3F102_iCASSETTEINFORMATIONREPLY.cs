...
namespace WinSECS
{
    public class S3F102_iCASSETTEINFORMATIONREPLY
    {
        public static SECSTransaction makeTransaction(bool isNoPadding , String ack6, String ptid, String csid, String jobid, List<S3F102_iCASSETTEINFORMATIONREPLY_GLASS_COUNT> glass_count)
        {
			...
			ListFormat listNode_1 = listNode_0.add(ListFormat.TYPE, 4, "", "") as ListFormat;
			...
			if(glass_count != null)
			{
				foreach (S3F102_iCASSETTEINFORMATIONREPLY_GLASS_COUNT item in glass_count)
				{

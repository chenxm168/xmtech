...
namespace WinSECS
{
    public class S5F102_ALARMLISTREPLY_TYPE1_TOOL_COUNT
    {
        private ListFormat ownerList = new ListFormat();

		private String toolid= "";
		private String tiack= "";
		private List<S5F102_ALARMLISTREPLY_TYPE1_TOOL_COUNT_ALARM_COUNT> alarm_count= new List<S5F102_ALARMLISTREPLY_TYPE1_TOOL_COUNT_ALARM_COUNT>();

        public S5F102_ALARMLISTREPLY_TYPE1_TOOL_COUNT(String toolid, String tiack, List<S5F102_ALARMLISTREPLY_TYPE1_TOOL_COUNT_ALARM_COUNT> alarm_count)
        {
			this.toolid = toolid;
			this.tiack = tiack;
        ...
        public ListFormat getMessage(bool isNoPadding)
        {
			...
			if(alarm_count != null)
			{
				foreach (S5F102_ALARMLISTREPLY_TYPE1_TOOL_COUNT_ALARM_COUNT item in alarm_count)
				{

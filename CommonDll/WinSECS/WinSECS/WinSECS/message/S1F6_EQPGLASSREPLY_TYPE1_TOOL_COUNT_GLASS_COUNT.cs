...
namespace WinSECS
{
    public class S1F6_EQPGLASSREPLY_TYPE1_TOOL_COUNT_GLASS_COUNT
    {
        ...
        public S1F6_EQPGLASSREPLY_TYPE1_TOOL_COUNT_GLASS_COUNT(String lotid, String ipid, String opid, String icid, String ocid, String jobid, String processid, String partid, String stepid, String ppid, String glasstype, String glassid, String slotno, String glass_state, String unitid)
        {
			this.lotid = lotid;
			this.ipid = ipid;
			this.opid = opid;

...
namespace WinSECS
{
    public class S1F6_iEQPCOMPONENTREPLY_TOOL_COUNT_GLASS_COUNT
    {
        ...
        public S1F6_iEQPCOMPONENTREPLY_TOOL_COUNT_GLASS_COUNT(String ptid, String csid, String ipid, String icid, String jobid, String slotno, String processid, String partid, String stepid, String glasstype, String lotid, String hglassid, String rglassid, String ppid, String cellgrade, String direction, String glass_state, String unitid, String glasssize, String stdcell, String lotkind, String runline, String result, String judgement, String ngcode, String position, String pairslotno, String pairipid, String pairicid, String pairlotid, String pairhglassid, String pairrglassid, String lotrule)
        {
			this.ptid = ptid;
			this.csid = csid;
			this.ipid = ipid;

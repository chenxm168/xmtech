...
namespace WinSECS
{
    public class S1F11_FDCEQPSTATUSNAMELISTREQUEST_TOOL_COUNT
    {
        ...
        public S1F11_FDCEQPSTATUSNAMELISTREQUEST_TOOL_COUNT()
        {
        }

        public S1F11_FDCEQPSTATUSNAMELISTREQUEST_TOOL_COUNT(ListFormat rootFormat)
        {
        }

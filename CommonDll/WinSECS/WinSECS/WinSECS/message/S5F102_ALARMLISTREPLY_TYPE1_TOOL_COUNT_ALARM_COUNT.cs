...
namespace WinSECS
{
    public class S5F102_ALARMLISTREPLY_TYPE1_TOOL_COUNT_ALARM_COUNT
    {
        ...
        public S5F102_ALARMLISTREPLY_TYPE1_TOOL_COUNT_ALARM_COUNT(String alcd, String alid, String altx, String unitid, String altm)
        {
			this.alcd = alcd;
			this.alid = alid;
			this.altx = altx;

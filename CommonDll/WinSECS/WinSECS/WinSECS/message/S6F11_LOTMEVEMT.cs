...
namespace WinSECS
{
    public class S6F11_LOTMEVEMT
    {
        public static SECSTransaction makeTransaction(bool isNoPadding , String dataid, String ceid, String rptid, String toolid, String mcmd, String eqst, String bywho, String rptid1, String lotid, String glasstype)
        {
			...
			ListFormat listNode_5 = listNode_4.add(ListFormat.TYPE, 2, "", "") as ListFormat;
			if (isNoPadding)
				listNode_5.add(AsciiFormat.TYPE, Encoding.GetEncoding("ks_c_5601-1987").GetBytes(lotid).Length, "LOTID", lotid);
			else
				listNode_5.add(AsciiFormat.TYPE, 16, "LOTID", lotid);
			if (isNoPadding)
				listNode_5.add(AsciiFormat.TYPE, Encoding.GetEncoding("ks_c_5601-1987").GetBytes(glasstype).Length, "GLASSTYPE", glasstype);
			else
				listNode_5.add(AsciiFormat.TYPE, 2, "GLASSTYPE", glasstype);

...
namespace WinSECS
{
    public class S1F6_iEQPPROCESSREPLY_TOOL_COUNT_PORT_COUNT
    {
		...
		private List<S1F6_iEQPPROCESSREPLY_TOOL_COUNT_PORT_COUNT_GLASS_COUNT> glass_count= new List<S1F6_iEQPPROCESSREPLY_TOOL_COUNT_PORT_COUNT_GLASS_COUNT>();

        public S1F6_iEQPPROCESSREPLY_TOOL_COUNT_PORT_COUNT(String ptid, String csid, String jobid, String jstate, String stif, String totalgstate, String ptmd, String unloadtype, String ptst, String splitmode, String sortmode, List<S1F6_iEQPPROCESSREPLY_TOOL_COUNT_PORT_COUNT_GLASS_COUNT> glass_count)
        {
			this.ptid = ptid;
			this.csid = csid;
			this.jobid = jobid;
        ...
        public ListFormat getMessage(bool isNoPadding)
        {
			...
			if(glass_count != null)
			{
				foreach (S1F6_iEQPPROCESSREPLY_TOOL_COUNT_PORT_COUNT_GLASS_COUNT item in glass_count)
				{

...
namespace WinSECS
{
    public class S1F4_FDCEQPSTATUSREPLY_TYPE1_TOOL_COUNT_SVID_COUNT
    {
        ...
        public S1F4_FDCEQPSTATUSREPLY_TYPE1_TOOL_COUNT_SVID_COUNT(String unitid, String svid, String sv)
        {
			this.unitid = unitid;
			this.svid = svid;
			this.sv = sv;

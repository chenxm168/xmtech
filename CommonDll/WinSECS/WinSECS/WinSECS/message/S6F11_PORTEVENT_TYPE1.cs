...
namespace WinSECS
{
    public class S6F11_PORTEVENT_TYPE1
    {
        public static SECSTransaction makeTransaction(bool isNoPadding , String dataid, String ceid, String rptid, String toolid, String mcmd, String eqst, String bywho, String rptid1, String action, String ptid, String ptmd, String csid, String stif, String csttype)
        {
			...
			ListFormat listNode_5 = listNode_4.add(ListFormat.TYPE, 6, "", "") as ListFormat;
			sArray =  action.Split(' ');
			if (isNoPadding)
			...
			if (isNoPadding)
				listNode_5.add(AsciiFormat.TYPE, Encoding.GetEncoding("ks_c_5601-1987").GetBytes(ptmd).Length, "PTMD", ptmd);
			else
			...
			if (isNoPadding)
				listNode_5.add(AsciiFormat.TYPE, Encoding.GetEncoding("ks_c_5601-1987").GetBytes(stif).Length, "STIF", stif);
			else

...
namespace WinSECS
{
    public class S3F101_CASSETTEINFORMATIONSEND_TYPE3_GLASS_COUNT
    {
        ...
        public S3F101_CASSETTEINFORMATIONSEND_TYPE3_GLASS_COUNT()
        {
        }

        public S3F101_CASSETTEINFORMATIONSEND_TYPE3_GLASS_COUNT(ListFormat rootFormat)
        {
        }

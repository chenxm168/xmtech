...
namespace WinSECS
{
    public class S6F11_iSPECIALEVENT_MATERIAL_COUNT
    {
        ...
        public S6F11_iSPECIALEVENT_MATERIAL_COUNT(String mname, String mvalue)
        {
			this.mname = mname;
			this.mvalue = mvalue;
        ...
        public ListFormat getMessage(bool isNoPadding)
        {
			...
			if (isNoPadding)
				...
				ownerList.add(AsciiFormat.TYPE, 80, "MVALUE", mvalue);

...
namespace WinSECS
{
    public class S6F13_DFSDATACOLLECTION_TYPE3
    {
        public static SECSTransaction makeTransaction(bool isNoPadding , String dataid, String ceid, String rptid, String ipidname, String ipid, String opidname, String opid, String icidname, String icid, String ocidname, String ocid, String jobidname, String jobid, String slotnoname, String slotno, String processidname, String processid, String partidname, String partid, String stepidname, String stepid, String glasstypename, String glasstype, String glassidname, String glassid, String ppidname, String ppid, String glassstatename, String gstate, String out_slotnoname, String out_slotno, String vcr_glassidname, String vcr_glassid, String rptid1, List<S6F13_DFSDATACOLLECTION_TYPE3_LEVEL_COUNT> level_count)
        {
			...
			ListFormat listNode_3 = listNode_2.add(ListFormat.TYPE, 15, "", "") as ListFormat;
			...
			if (isNoPadding)
				listNode_9.add(AsciiFormat.TYPE, Encoding.GetEncoding("ks_c_5601-1987").GetBytes(slotnoname).Length, "SLOTNONAME", slotnoname);
			else
			...
			if (isNoPadding)
				listNode_14.add(AsciiFormat.TYPE, Encoding.GetEncoding("ks_c_5601-1987").GetBytes(glassidname).Length, "GLASSIDNAME", glassidname);
			else
			...
			if (isNoPadding)
				listNode_15.add(AsciiFormat.TYPE, Encoding.GetEncoding("ks_c_5601-1987").GetBytes(ppidname).Length, "PPIDNAME", ppidname);
			else
			...
			if (isNoPadding)
				listNode_16.add(AsciiFormat.TYPE, Encoding.GetEncoding("ks_c_5601-1987").GetBytes(glassstatename).Length, "GLASSSTATENAME", glassstatename);
			else
			...
			if (isNoPadding)
				listNode_17.add(AsciiFormat.TYPE, Encoding.GetEncoding("ks_c_5601-1987").GetBytes(out_slotnoname).Length, "OUT_SLOTNONAME", out_slotnoname);
			else
				listNode_17.add(AsciiFormat.TYPE, 10, "OUT_SLOTNONAME", out_slotnoname);
			if (isNoPadding)
				listNode_17.add(AsciiFormat.TYPE, Encoding.GetEncoding("ks_c_5601-1987").GetBytes(out_slotno).Length, "OUT_SLOTNO", out_slotno);
			else
				listNode_17.add(AsciiFormat.TYPE, 2, "OUT_SLOTNO", out_slotno);
			ListFormat listNode_18 = listNode_3.add(ListFormat.TYPE, 2, "", "") as ListFormat;
			if (isNoPadding)
				listNode_18.add(AsciiFormat.TYPE, Encoding.GetEncoding("ks_c_5601-1987").GetBytes(vcr_glassidname).Length, "VCR_GLASSIDNAME", vcr_glassidname);
			else
				listNode_18.add(AsciiFormat.TYPE, 10, "VCR_GLASSIDNAME", vcr_glassidname);
			if (isNoPadding)
				listNode_18.add(AsciiFormat.TYPE, Encoding.GetEncoding("ks_c_5601-1987").GetBytes(vcr_glassid).Length, "VCR_GLASSID", vcr_glassid);
			else
				listNode_18.add(AsciiFormat.TYPE, 20, "VCR_GLASSID", vcr_glassid);
			ListFormat listNode_19 = listNode_1.add(ListFormat.TYPE, 2, "", "") as ListFormat;
			sArray =  rptid1.Split(' ');
			if (isNoPadding)
				listNode_19.add(Uint1Format.TYPE, sArray.Length, "RPTID1", rptid1);
			else
				listNode_19.add(Uint1Format.TYPE, 1, "RPTID1", rptid1);
			ListFormat listNode_LEVEL_COUNT = listNode_19.add(ListFormat.TYPE, -1, "LEVEL_COUNT", "") as ListFormat;
			if(level_count != null)
			{
				foreach (S6F13_DFSDATACOLLECTION_TYPE3_LEVEL_COUNT item in level_count)
				{

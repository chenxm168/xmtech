...
namespace WinSECS
{
    class S3F101_CASSETTEINFORMATIONSEND_TYPE3
    {
		...
		private List<S3F101_CASSETTEINFORMATIONSEND_TYPE3_GLASS_COUNT> glass_count= new List<S3F101_CASSETTEINFORMATIONSEND_TYPE3_GLASS_COUNT>();
		...
		public List<S3F101_CASSETTEINFORMATIONSEND_TYPE3_GLASS_COUNT> GLASS_COUNT
		{
        ...
        public S3F101_CASSETTEINFORMATIONSEND_TYPE3(SECSTransaction trx)
        {
            this.trx = trx;
        ...
        public void FillItemValue(SECSTransaction trx)
        {
			...
			{
				S3F101_CASSETTEINFORMATIONSEND_TYPE3_GLASS_COUNT vList = new S3F101_CASSETTEINFORMATIONSEND_TYPE3_GLASS_COUNT();

...
namespace WinSECS
{
    public class S6F11_GLASSEVENT_TYPE2
    {
        public static SECSTransaction makeTransaction(bool isNoPadding , String dataid, String ceid, String rptid, String toolid, String mcmd, String eqst, String bywho, String rptid1, String lotid, String ipid, String opid, String icid, String ocid, String jobid, String ppid, String processid, String partid, String stepid, String glasstype, String glassid, String fslotno, String tslotno, String vcr_glassid, String f_porttype, String t_porttype, String eo_val, String unitid, String result, String judgement, String ngcode)
        {
			...
			ListFormat listNode_6 = listNode_5.add(ListFormat.TYPE, 17, "", "") as ListFormat;
			if (isNoPadding)
			...
			if (isNoPadding)
				listNode_6.add(AsciiFormat.TYPE, Encoding.GetEncoding("ks_c_5601-1987").GetBytes(vcr_glassid).Length, "VCR_GLASSID", vcr_glassid);
			else
				listNode_6.add(AsciiFormat.TYPE, 20, "VCR_GLASSID", vcr_glassid);
			if (isNoPadding)
				listNode_6.add(AsciiFormat.TYPE, Encoding.GetEncoding("ks_c_5601-1987").GetBytes(f_porttype).Length, "F_PORTTYPE", f_porttype);
			else
				listNode_6.add(AsciiFormat.TYPE, 6, "F_PORTTYPE", f_porttype);
			if (isNoPadding)
				listNode_6.add(AsciiFormat.TYPE, Encoding.GetEncoding("ks_c_5601-1987").GetBytes(t_porttype).Length, "T_PORTTYPE", t_porttype);
			else
				listNode_6.add(AsciiFormat.TYPE, 6, "T_PORTTYPE", t_porttype);

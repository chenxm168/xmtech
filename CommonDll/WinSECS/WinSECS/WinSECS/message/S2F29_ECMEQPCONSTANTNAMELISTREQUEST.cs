...
namespace WinSECS
{
    class S2F29_ECMEQPCONSTANTNAMELISTREQUEST
    {
        private BasicTransactionInfo basicTrxInfo;
        private SECSTransaction trx;

		private List<S2F29_ECMEQPCONSTANTNAMELISTREQUEST_TOOL_COUNT> tool_count= new List<S2F29_ECMEQPCONSTANTNAMELISTREQUEST_TOOL_COUNT>();
		...
		public List<S2F29_ECMEQPCONSTANTNAMELISTREQUEST_TOOL_COUNT> TOOL_COUNT
		{
        ...
        public S2F29_ECMEQPCONSTANTNAMELISTREQUEST(SECSTransaction trx)
        {
            this.trx = trx;
        ...
        public void FillItemValue(SECSTransaction trx)
        {
			...
			{
				S2F29_ECMEQPCONSTANTNAMELISTREQUEST_TOOL_COUNT vList = new S2F29_ECMEQPCONSTANTNAMELISTREQUEST_TOOL_COUNT();

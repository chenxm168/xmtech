...
namespace WinSECS
{
    public class S6F11_EQPEVENT
    {
        public static SECSTransaction makeTransaction(bool isNoPadding , String dataid, String ceid, String rptid, String toolid, String mcmd, String eqst, String bywho, String rptid1, List<String> unit_count)
        {
			...
			listNode_4.add(CPrivateUtility.getMessage(isNoPadding, unit_count, AsciiFormat.TYPE, "UNITID", -1));
